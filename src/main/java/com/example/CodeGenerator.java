...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws Exception {
        // ======== 基本配置 ========
        String jdbcUrl = "jdbc:mysql://localhost:3306/order_system";
        String username = "root";
        String password = "Bai159357";
        String outDir = "F:/WorkSpace/JavaProjects/CodeGeneration/OrderSystem";
        String basePackage = "com.yangbaibai";
        String moduleName = "ordersystem";
        String author = "BaiJinBo";
        String applicationName = "OrderSystem"; // 是否生成Application, 若为null则不生成
